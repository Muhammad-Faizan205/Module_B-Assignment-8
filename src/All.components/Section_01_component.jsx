...
import block54 from '../images/1.4 img.avif'
...
import block61 from '../images/3.1.avif'
import block62 from '../images/3.2.avif'
import heading3 from '../images/block5h3.avif'

function Section_01_component(){
    return(
        ...
        <h4 className='mx-3 fw-bold text-3xl'>Recommended for you</h4>
        </div>
    )
}
